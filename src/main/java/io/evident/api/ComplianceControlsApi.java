...
public interface ComplianceControlsApi {
  ...
  Call<PaginatedCollection> listSignatures(
    @retrofit2.http.Path("compliance_control_id") Integer complianceControlId, @retrofit2.http.Field("page") String page, @retrofit2.http.Query("include") String include
  );
