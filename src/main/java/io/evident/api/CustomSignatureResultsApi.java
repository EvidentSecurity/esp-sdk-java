...
public interface CustomSignatureResultsApi {
  ...
  Call<PaginatedCollection> listAlerts(
    @retrofit2.http.Path("custom_signature_result_id") Integer customSignatureResultId, @retrofit2.http.Query("include") String include, @retrofit2.http.Field("page") String page
  );
