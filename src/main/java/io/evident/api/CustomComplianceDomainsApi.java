...
public interface CustomComplianceDomainsApi {
  ...
  Call<CustomComplianceDomain> create(
    @retrofit2.http.Field("identifier") String identifier, @retrofit2.http.Field("custom_compliance_standard_id") Integer customComplianceStandardId, @retrofit2.http.Field("name") String name, @retrofit2.http.Field("position") Integer position, @retrofit2.http.Query("include") String include
  );
  ...
  Call<CustomComplianceDomain> update(
    @retrofit2.http.Path("id") Integer id, @retrofit2.http.Field("identifier") String identifier, @retrofit2.http.Field("custom_compliance_standard_id") Integer customComplianceStandardId, @retrofit2.http.Field("name") String name, @retrofit2.http.Field("position") Integer position, @retrofit2.http.Query("include") String include
  );
