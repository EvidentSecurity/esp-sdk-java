...
public interface ExternalAccountsAzureApi {
  ...
  Call<ExternalAccountAzure> create(
    @retrofit2.http.Field("app_key") String appKey, @retrofit2.http.Field("client_id") String clientId, @retrofit2.http.Field("name") String name, @retrofit2.http.Field("subscription_id") String subscriptionId, @retrofit2.http.Field("team_id") Integer teamId, @retrofit2.http.Field("tenant_id") String tenantId
  );
  ...
  Call<ExternalAccountAzure> update(
    @retrofit2.http.Path("external_account_id") Integer externalAccountId, @retrofit2.http.Field("app_key") String appKey, @retrofit2.http.Field("client_id") String clientId, @retrofit2.http.Field("name") String name, @retrofit2.http.Field("subscription_id") String subscriptionId, @retrofit2.http.Field("team_id") Integer teamId, @retrofit2.http.Field("tenant_id") String tenantId
  );
