...
public interface UserAttributionsApi {
  ...
  Call<ExternalAccount> update(
    @retrofit2.http.Path("external_account_id") Integer externalAccountId, @retrofit2.http.Field("cloudtrail_name") String cloudtrailName, @retrofit2.http.Query("include") String include
  );
