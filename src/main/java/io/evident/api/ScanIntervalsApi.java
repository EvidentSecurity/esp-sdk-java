...
public interface ScanIntervalsApi {
  ...
  Call<ScanInterval> update(
    @retrofit2.http.Path("id") Integer id, @retrofit2.http.Query("include") String include, @retrofit2.http.Field("external_account_id") Integer externalAccountId, @retrofit2.http.Field("interval") Integer interval, @retrofit2.http.Field("service_id") Integer serviceId
  );
