...
public class JsonApiUnitTest {
    ...
    public void testIncludedObjects() throws IOException {
        ...
        assertEquals(1, (int) alert.getExternalAccount().getTeam().getOrganization().getId());
