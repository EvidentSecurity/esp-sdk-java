...
- API version: v2_sdk
- Build date: 2018-04-25T13:00:36.864-05:00
...
*::StatComplianceControlsApi* | [**listForStat**](docs/StatComplianceControlsApi.md#listForStat) | **GET** api/v2/stats/{stat_id}/compliance_controls.json_api | Statistics for compliance controls
...
*::StatCustomComplianceControlsApi* | [**listForStat**](docs/StatCustomComplianceControlsApi.md#listForStat) | **GET** api/v2/stats/{stat_id}/custom_compliance_controls.json_api | Statistics for custom compliance controls
...
*::StatCustomSignaturesApi* | [**listForStat**](docs/StatCustomSignaturesApi.md#listForStat) | **GET** api/v2/stats/{stat_id}/custom_signatures.json_api | Statistics for custom signatures
...
*::StatRegionsApi* | [**listForStat**](docs/StatRegionsApi.md#listForStat) | **GET** api/v2/stats/{stat_id}/regions.json_api | Get a list of statistics for regions
*::StatRegionsApi* | [**show**](docs/StatRegionsApi.md#show) | **GET** api/v2/stats/regions/{id}.json_api | Show a single Stat Region
*::StatServicesApi* | [**listForStat**](docs/StatServicesApi.md#listForStat) | **GET** api/v2/stats/{stat_id}/services.json_api | Get a list of statistics for services
*::StatServicesApi* | [**show**](docs/StatServicesApi.md#show) | **GET** api/v2/stats/services/{id}.json_api | Show a single Stat Service
*::StatSignaturesApi* | [**listForStat**](docs/StatSignaturesApi.md#listForStat) | **GET** api/v2/stats/{stat_id}/signatures.json_api | Get a list of statistics for signatures
...
*::StatsApi* | [**latestForTeams**](docs/StatsApi.md#latestForTeams) | **PUT** api/v2/stats/latest_for_teams.json_api | Statistics for teams
